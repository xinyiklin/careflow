...
export default function LoadingScreen({
  ...
  return (
    <div className="cf-loading-screen flex h-[100dvh] w-full items-center justify-center bg-cf-page-bg px-6 text-cf-text">
      <div className="relative w-full max-w-lg overflow-hidden rounded-[var(--radius-cf-shell)] border border-cf-border-strong bg-cf-surface px-8 py-8 shadow-[var(--shadow-panel-lg)]">
        <div className="relative">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-cf-border bg-cf-surface-soft text-cf-text">
          ...
          <div className="mt-7 space-y-3" aria-hidden="true">
            <div className="h-3 w-11/12 rounded-full bg-cf-surface-soft" />
            <div className="h-3 w-8/12 rounded-full bg-cf-surface-soft" />
            <div className="h-3 w-10/12 rounded-full bg-cf-surface-soft" />
          </div>
