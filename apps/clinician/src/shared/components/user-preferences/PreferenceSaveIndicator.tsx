...
const states = {
  pending: { Icon: Cloud, label: "Unsaved changes", color: "text-cf-text-subtle" },
  saving: { Icon: CloudUpload, label: "Saving changes", color: "text-cf-text-subtle" },
  saved: { Icon: CloudCheck, label: "All changes saved", color: "text-cf-text-subtle" },
...
export default function PreferenceSaveIndicator({ status }: { status: SaveStatus }) {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="invisible absolute top-full right-0 z-10 pt-2 group-hover:visible group-focus-visible:visible"
      >
