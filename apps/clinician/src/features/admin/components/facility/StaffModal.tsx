      ...
      >
        <form id="staff-form" onSubmit={handleSubmit}>
          <div className="space-y-6">
            {/* Tabs Selector for Edit Mode — each tab fully swaps the body */}
            {isEditMode && (
              <Tabs
                options={[
                ...
                ariaLabel="Staff member detail sections"
                idBase={tabsId}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="flex flex-col gap-1.5">
                        <span className="text-[10px] font-semibold uppercase tracking-wider text-cf-text-subtle">
                          User Account
                        </span>
                        <Input
                          as="select"
                    ...
                    <label className="flex items-start gap-3 rounded-xl border border-cf-border bg-cf-surface px-3 py-2.5 cursor-pointer hover:bg-cf-surface-soft transition">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[11px] text-cf-text-muted mt-0.5">
                          Patients can see this provider's available slots in
                          the portal. Must also have at least one bookable
                          appointment type and at least one open slot.
                        </div>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start gap-3 rounded-xl border border-cf-border bg-cf-surface px-3 py-2.5 cursor-pointer hover:bg-cf-surface-soft transition">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[11px] text-cf-text-muted mt-0.5">
                          ...
                          <em>pending</em> for staff review. The appointment
                          type must also enable auto-confirm.
                        </div>
                      </div>
                    </label>
