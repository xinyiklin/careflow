...
CORS_ALLOWED_ORIGINS=https://clinician.xinyiklin.com,https://patient.xinyiklin.com
CSRF_TRUSTED_ORIGINS=https://clinician.xinyiklin.com,https://patient.xinyiklin.com,https://api.careflow.xinyiklin.com
DEMO_MODE=True
DEMO_USERNAME=demo
PATIENT_DOCUMENT_STORAGE_BACKEND=r2
```
