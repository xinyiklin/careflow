...
import type { AdminSavePayload, AdminStaffRole } from "../../types";
...
export default function StaffRoleModal({
  ...
  isOpen: boolean;
  mode?: "create" | "edit";
  initialValues?: AdminStaffRole | null;
  saving?: boolean;
  onClose: () => void;
  ...
  return (
    ...
    >
      <form id="staff-role-form" onSubmit={handleSubmit} className="space-y-4">
        ...
        {isSystem && (
          <p className="rounded-xl border border-cf-border bg-cf-surface-soft/60 px-3 py-2 text-xs text-cf-text-muted">
            ...
            permissions from the Roles view.
          </p>
        )}
      </form>
    </AdminFormModal>
